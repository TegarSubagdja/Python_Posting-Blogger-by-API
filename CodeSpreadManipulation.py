...
# 2. Pilih Worksheet (Tab pertama)
worksheet = sh.sheet1 

# 3. Data yang akan diupload
...
# 4. Update data ke worksheet (Gunakan objek 'worksheet', bukan 'sh')
worksheet.update('A1', data_to_upload)

# 5. Ambil data kembali untuk verifikasi
data = worksheet.get_all_records()

# 6. Tampilkan dengan Pandas
